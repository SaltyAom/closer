...
var generate = function generate(init) {
...
document.getElementById("code").onkeydown = function (event) {
  ...
  if (event.keyCode !== 65 && event.keyCode !== 66 && event.keyCode !== 67 && event.keyCode !== 68 && event.keyCode !== 69 && event.keyCode !== 70) {
...
document.getElementById("code").onchange = function (evt) {
  generate();
};
